...
React JS is a library that creates UI elements and renders them to the DOM/Virtual DOM. React uses data and renders UI elements. Because the data usually changes, React can change with the data and keep the UI in an up to date status with the current data.

- [x] What does it mean to _think_ in react?

It means to blow your brains out with an AT-4! It really means to think about where your data is coming from, what do you have to do with it, and what states should it possess.

- [x] Describe state.

State is the 'being' of data. In other words, what is the data doing right now, what was the data doing, or what will it be doing in the future. You can look at it like the position it holds at specific interval.

- [x] Describe props.

Props are specific points that identify a certain 'thing' about a component. It usually points to an attribute of a piece of data.

- [x] What are side effects, and how do you sync effects in a React component to state or prop changes?

Side effect can be sync by using the second argument of the useEffect hook. Side effects allow us to perform specific types of functions dependent upon what is happening to the components within the app.
